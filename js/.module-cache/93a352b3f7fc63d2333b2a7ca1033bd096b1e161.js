...
var Togglemenuitem = React.createClass({displayName: "Togglemenuitem",
	...
	render: function() {
		return React.createElement("div", {className: "menu-item", onClick: this.navigate.bind(this, this.props.hash)}, this.props.children.format(this.state.activated ? this.porps.on : this.props.off));
	}
});
