...
var Togglemenuitem = React.createClass({displayName: "Togglemenuitem",
	...
	render: function() {
		return React.createElement("div", {className: "menu-item", onClick: this.props.navigate.bind(this, this.state.activated)}, this.props.children.format(this.state.activated ? this.porps.on : this.props.off));
	}
});
