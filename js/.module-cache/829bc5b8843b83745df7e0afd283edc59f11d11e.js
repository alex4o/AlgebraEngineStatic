...
var routes = (
  React.createElement(ReactRouter.Route, {handler: App, path: "/"}, 
    ...
    React.createElement(Route, {name: "problems", handler: Users}, 
      React.createElement(Route, {name: "", path: "/Problem/Equation", handler: Equation}), 
      React.createElement(Route, {name: "", path: "/Problem/EquivalentExpressions", handler: EquivalentExpressions}), 
