	...
	render: function () {
		...
		React.createElement("div", {id: "content"}, 
				React.createElement(Menu, {ref: "menu"}, 
						...
						React.createElement(MenuItem, {hash: "#/Problem/EquivalentExpressions"}, "Уравнения"), 
...
var routes = (
  React.createElement(ReactRouter.Route, {handler: App, path: "/"}, 
    ...
    React.createElement(ReactRouter.Route, {name: "about", handler: About}), 
    React.createElement(ReactRouter.Route, {name: "problems", handler: Users}, 
      ...
      React.createElement(ReactRouter.NotFoundRoute, {handler: UserRouteNotFound})
    )
  )
);
