			...
			React.createElement("div", {id: "inner-content"}, 
				...
				React.createElement("div", null, 
					React.createElement("div", {className: "menu"}, 
						...
						React.createElement(Togglemenuitem, {action: this.show, on: "low", off: "high"}, '{0} отговорите')
					), 
...
var Togglemenuitem = React.createClass({displayName: "Togglemenuitem",
	...
	render: function() {
		return React.createElement("div", {className: "menu-item", onClick: this.props.action.bind(this, this.state.activated)}, this.props.children.format(this.state.activated ? this.porps.on : this.props.off));
	}
});
